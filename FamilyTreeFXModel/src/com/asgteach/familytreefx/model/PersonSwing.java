...
public class PersonSwing implements Serializable {
    private long id;
    private String firstname;
    private String middlename;
    private String lastname;
    private String suffix;
    private PersonSwing.Gender gender;
    ...
    public PersonSwing(String first, String last, PersonSwing.Gender gender) {
    ...
    public PersonSwing(PersonSwing person) {
    ...
    public PersonSwing.Gender getGender() {
        return gender;
    }

    public void setGender(PersonSwing.Gender gender) {
        PersonSwing.Gender oldGender = this.gender;
        this.gender = gender;
    ...
    public boolean equals(Object obj) {
        ...
        final PersonSwing other = (PersonSwing) obj;
